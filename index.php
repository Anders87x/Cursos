                ...
                <nav uk-navbar="">
                    ...
                    <div class="uk-navbar-right">
                        <div class="header-widget">
                            ...
                            <a href="view/Register" class="btn btn-info transition-3d-hover ml-3"> Registrate</a>

                           <!--  <div id="divacceso">
                                <a href="#" class="header-widget-icon" uk-tooltip="title: Mis Cursos ; pos: bottom ;offset:21">
